...
- **[docs/nav-rbac.md](./docs/nav-rbac.md)** — Navigation RBAC: client-side access control based on user tiers
- **[docs/clerk_setup.md](./docs/clerk_setup.md)** — Clerk auth setup: basic authentication and environment variables
